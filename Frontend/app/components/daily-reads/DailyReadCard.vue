...
<template>
  <div
    class="relative w-full h-full border-5 border-primary rounded-[36px] overflow-hidden bg-cover bg-center cursor-pointer transition-all duration-300 hover:shadow-2xl active:scale-95 group bg-muted"
